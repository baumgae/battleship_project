 ...
 * <p>
 * After the game has ended, the users recieve this screen, The one who looses,
 * will get the "You Loose" part of the screen. <br>
...
public class EndingScreen {
	...
	public VBox getScreen() {
		...
		if (playerOneScore < playerTwoScore) {
			...
			leftBox.getChildren().addAll(labelTitle, labelTitle2, labelTitle3, labelTitle4, labelTitle5);
			...
			rightBox.getChildren().addAll(labelTitle6, labelTitle7, labelTitle8, labelTitle9, labelTitle10);
			...
			leftBox.getChildren().addAll(labelTitle, labelTitle1, labelTitle2, labelTitle3, labelTitle4);
		...
		newGame.setOnAction(event -> newGame.setText("Clicked!"));
		...
		backToMenu.setOnAction(event -> backToMenu.setText("You may not leave!"));
