...
public class GameAreaScreen {
	...
	public VBox getScreen() {
		...
		if(GameManager.playerNumber == 1) {
			...
			// Versuchen untere Methode aufzurufen, um GameArea inklusive Items und Schiffe zu haben.
			...
			// Versuchen untere Methode aufzurufen...
	...
	//Modifizierte Methode renderGameArea - Original ist zu finden in der SetShipArea
