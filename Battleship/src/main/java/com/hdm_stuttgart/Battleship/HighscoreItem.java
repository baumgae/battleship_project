 ...
 * 
 * {@link #HighscoreItem(String, int)} is the constructor for saving a new
 * HighscoreItem. So if a new HighscoreItem will be instantiated, a name and a
 * score has to be given as parameters. <br>
