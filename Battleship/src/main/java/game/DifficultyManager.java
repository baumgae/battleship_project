 ...
 * 
 * <p>
 * The Method {@link #getFieldSize(EDifficulty)} is for the GameAreaFactory so
 * it will get the MaxX and MaxY Values. The GameArea will be as big as it will
 * be chosen. {@link #getNumberOfDolphins(EDifficulty)} returns the number of
 * dolphins depending on the chosen difficulty. <br>
 * {@link #getNumberOfIslands(EDifficulty)} returns the number of islands
 * depending on the chosen difficulty. <br>
 * {@link #getNumberOfLuckyDwarfs(EDifficulty)} returns the number of lucky
 * dwarfs depending on the chosen difficulty. <br>
 * {@link #getNumberOfMines(EDifficulty)} returns the number of mines depending
 * on the chosen difficulty. <br>
 * {@link #getNumberOfOneFieldBoats(EDifficulty)} returns the number of one
 * field boats depending on the chosen difficulty. <br>
 * <p>
 * 
...
public class DifficultyManager {
	...
	/**
	 * Method for getting the number of dolphins depending on the chosen
	 * difficulty
	 * 
	 * @param difficulty
	...
	/**
	 * Method for getting the number of islands depending on the chosen
	 * difficulty
	 * 
	 * @param difficulty
	...
	/**
	 * Method for getting the number of lucky dwarfs depending on the chosen
	 * difficulty
	 * 
	 * @param difficulty
	...
	/**
	 * Method for getting the number of one field boats depending on the chosen
	 * difficulty
	 * 
	 * @param difficulty
	 ...
	 * switch (difficulty) {
	 * 
	 * case EASY: logger.info("The number of EASY has been choosen!"); return 2;
	 * 
	 * case NORMAL: logger.info("The number of NORMAL has been choosen!");
	 * return 2;
	 * 
	 * case HARD: logger.info("The number of HARD has been choosen!"); return 4;
	 * 
	 * case SUICIDAL: logger.info("The number of SUICIDAL has been choosen!");
	 * return 5;
	 * 
	 * default: logger.debug("The number of the default case has been taken!");
	 * return 1; } }
	 * 
	 ...
	 * return 5;
	 * 
	 * default: logger.info("The number of the default case has been taken!");
	 * return 1; } }
	 * 
